...
export default function TopNavBar({ onCategorySelect }: TopNavBarProps) {
  ...
  const handleCategorySelect = (category: string) => {
    ...
    onCategorySelect(category); // Trigger parent callback
    setShowCategory(false); // Close the offcanvas after selection
  };
